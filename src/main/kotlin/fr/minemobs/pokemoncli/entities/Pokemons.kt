...
enum class Pokemons(private var pokemon: Pokemon) {
    ...
    BULBASAUR(Pokemon("Bulbasaur", 45, 49, 49, 45, 5, 0, arrayListOf(Types.GRASS, Types.POISON),
        hashMapOf(0 to "BULBASAUR", 16 to "IVYSAUR", 32 to "VENUSAUR"), 64, arrayListOf(Attacks.GROWL, Attacks.TACKLE))),
    ...
    CHARMANDER(Pokemon("Charmander", 39, 52, 65, 43, 5, 0, arrayListOf(Types.FIRE),
        hashMapOf(0 to "CHARMANDER", 16 to "CHARMELEON", 36 to "CHARIZARD"), 65, arrayListOf(Attacks.GROWL, Attacks.SCRATCH))),
    ...
    SQUIRTLE(Pokemon("Squirtle", 45, 49, 49, 45, 5, 0, arrayListOf(Types.WATER),
        hashMapOf(0 to "SQUIRTLE", 16 to "WARTORTLE", 36 to "BLASOISE"), 66, arrayListOf(Attacks.TACKLE, Attacks.TAIL_WHIP))),
